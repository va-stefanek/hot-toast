...
| attributes  | [`Record<string, string>`](https://www.typescriptlang.org/docs/handbook/utility-types.html#recordkeystype)                                                                                                    | Extra attributes to be added to the hot toast container. Attributes keys are prefixed with 'hot-toast'.                                                                                                                                                                                                    | Extra CSS classes to be added to the hot toast container.                                                                                                                                                                                                                 | Yes                         |
